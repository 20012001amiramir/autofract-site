...
<template>
  <section class="px-6 md:px-16 py-40 md:py-56 max-w-3xl mx-auto">
    <h2 class="font-display font-black text-chapter text-ink mb-10">
      {{ t('studio.headline') }}
    </h2>
    <div class="space-y-6 text-lg md:text-xl text-ink/80">
      <p>{{ t('studio.p1') }}</p>
      <p>{{ t('studio.p2') }}</p>
    </div>
